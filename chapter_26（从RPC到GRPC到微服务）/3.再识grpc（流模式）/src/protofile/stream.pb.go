...
func (x *StreamRepData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamRepData) ProtoMessage() {}

func (x *StreamRepData) ProtoReflect() protoreflect.Message {
	mi := &file_stream_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamRepData.ProtoReflect.Descriptor instead.
func (*StreamRepData) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{1}
}

func (x *StreamRepData) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_stream_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x70,
	...
	0x61, 0x1a, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x70, 0x44, 0x61, 0x74,
	...
	0x1a, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x70, 0x44, 0x61, 0x74, 0x61,
	...
	0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x70, 0x44, 0x61, 0x74, 0x61, 0x28,
	0x01, 0x30, 0x01, 0x42, 0x0e, 0x5a, 0x0c, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x66,
...
var file_stream_proto_goTypes = []interface{}{
	...
	(*StreamRepData)(nil), // 1: StreamRepData
}
var file_stream_proto_depIdxs = []int32{
	...
	1, // 3: Greeter.GetStream:output_type -> StreamRepData
	1, // 4: Greeter.PutStream:output_type -> StreamRepData
	1, // 5: Greeter.AllStream:output_type -> StreamRepData
...
func (x *greeterGetStreamClient) Recv() (*StreamRepData, error) {
	m := new(StreamRepData)
...
type Greeter_PutStreamClient interface {
	...
	CloseAndRecv() (*StreamRepData, error)
	grpc.ClientStream
}
...
func (x *greeterPutStreamClient) CloseAndRecv() (*StreamRepData, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(StreamRepData)
...
func (x *greeterAllStreamClient) Recv() (*StreamRepData, error) {
	m := new(StreamRepData)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greeterGetStreamServer) Send(m *StreamRepData) error {
...
type Greeter_PutStreamServer interface {
	SendAndClose(*StreamRepData) error
...
func (x *greeterPutStreamServer) SendAndClose(m *StreamRepData) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greeterAllStreamServer) Send(m *StreamRepData) error {
	return x.ServerStream.SendMsg(m)
}
